...
function myMenuFunction(){
  ...
  document.getElementById('query_submit').addEventListener('click',async()=>{
    const name = document.getElementById('query_name').value
    const email = document.getElementById('query_email').value
    const message = document.getElementById('query_msg').value
    const data = await postData('/mm',{name,email,message})
    if(data.success==-1)
    alert("Enter all details")
  document.getElementById('query_name').value =""
  document.getElementById('query_email').value =""
  document.getElementById('query_msg').value =""
  })